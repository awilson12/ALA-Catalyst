...
lambdas.1<-c(lambda.1.2[i], lambda.1.3[i], lambda.1.4[i],lambda.1.5[i],lambda.1.6[i],
             lambda.1.7[i],lambda.1.8[i],lambda.1.9[i],lambda.1.10[i])
...
lambdas.3<-c(0,0,0,0,0,0,lambda.3.8[i],lambda.3.9[i],lambda.3.10[i])
